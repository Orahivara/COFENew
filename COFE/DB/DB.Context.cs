...
namespace COFE.DB
{
    ...
    public partial class COFEEntities : DbContext
    {
        public COFEEntities()
            : base("name=COFEEntities")
        {
        }
        ...
        public virtual DbSet<CompositionProduct> CompositionProduct { get; set; }
        public virtual DbSet<BasketAll> BasketAll { get; set; }
